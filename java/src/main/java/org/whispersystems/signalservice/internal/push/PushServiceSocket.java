...
public class PushServiceSocket {
  ...
  public void verifyAccountCode(String verificationCode, String signalingKey,
      ...
      throws IOException
  {
    AccountAttributes signalingKeyEntity = new AccountAttributes(signalingKey, fetchesMessages,
                                                                 registrationId, voice);
  ...
  public void setAccountAttributes(String signalingKey, boolean fetchesMessages,
      ...
      throws IOException
  {
    AccountAttributes accountAttributes = new AccountAttributes(signalingKey, fetchesMessages,
                                                                registrationId, voice);
